package com.ricardo.android.git_issues;
...
import com.ricardo.android.git_issues.models.GithubIssue;
import com.ricardo.android.git_issues.models.GithubRepo;
import com.ricardo.android.git_issues.services.GithubAPI;
import com.ricardo.android.git_issues.services.GithubRepoDeserializer;
...
/*
Enumerar repositorios de Github dado un usuario utilizando Retrofit.
 Puede seleccionar un repositorio desde un campo desplegable y enumerar los problemas asignados al usuario para el repositorio seleccionado. A continuación, puede seleccionar un problema de un campo desplegable adicional y publicar un comentario sobre él. 
 Un DialogFragment se utiliza para introducir las credenciales para la autenticación.
 Como Retrofit se utiliza junto con RxJava2 durante este tutorial
*/
        ...
        switch (view.getId()) {
            ...
            case R.id.send_comment_button:
                ...
                if (!newComment.isEmpty()) {
                    ...
                    compositeDisposable.add(githubAPI.postComment(selectedItem.getComments_url(), selectedItem)
                            .subscribeOn(Schedulers.io())
                            .observeOn(AndroidSchedulers.mainThread())
